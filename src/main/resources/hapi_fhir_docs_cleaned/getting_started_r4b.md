---
source: https://hapifhir.io/hapi-fhir/docs/getting_started/r4b.html
crawled: 2025-08-01T14:05:29.318237
---

# Getting Started R4B

#  1.4.1FHIR R4B
[ ](https://hapifhir.io/hapi-fhir/docs/getting_started/r4b.html#fhir-r4b)
...
As of HAPI FHIR 6.2.0, this version is now supported. See [FHIR and HAPI FHIR Versions](https://hapifhir.io/hapi-fhir/docs/getting_started/versions.html) for a complete table of FHIR specification version support in HAPI FHIR software versions.
