---
source: https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html
crawled: 2025-08-01T14:05:53.810840
---

# Clinical Reasoning Plan Definitions

#  10.5.1PlanDefinition
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#plandefinition)
##  10.5.1.1Introduction[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#introduction)
...
##  10.5.1.2Operations[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#operations)
HAPI implements the following operations for PlanDefinitions:
  * [$apply](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#apply)
  * [$package](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#package)
  * [$data-requirements](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#datarequirements)


##  10.5.1.3Apply[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#apply)
...
Copy
10.5.1.3.1Parameters The following parameters are supported for the `PlanDefinition/$apply` and `PlanDefinition/$r5.apply` operation: Parameter | Type | Description  
---|---|---  
...
##  10.5.1.4Package[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#package)
...
10.5.1.4.1Parameters The following parameters are supported for the `PlanDefinition/$package` operation: Parameter | Type | Description  
---|---|---  
...
##  10.5.1.5DataRequirements[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#datarequirements)
...
10.5.1.5.1Parameters The following parameters are supported for the `PlanDefinition/$data-requirements` operation: Parameter | Type | Description  
---|---|---  
...
##  10.5.1.6Example PlanDefinition[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/plan_definitions.html#example-plandefinition)
```
{
...
Copy
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html)
10.5 PlanDefinitions 
* Clinical Reasoning 
