---
source: https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html
crawled: 2025-08-01T14:05:05.518808
---

# Clinical Reasoning Activity Definitions

#  10.4.1ActivityDefinition
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#activitydefinition)
##  10.4.1.1Introduction[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#introduction)
...
An ActivityDefinition resource provides a description, or template, of an action to perform. These actions can be purely text-based descriptions of the action to be performed, only interpretable by a human user, or they can be structured definitions with enough information to construct a resource to represent the request or activity directly. This process of converting the ActivityDefinition into a specific resource in a particular context is performed with the [$apply](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#apply) operation.
##  10.4.1.2Operations[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#operations)
HAPI implements the following operations for ActivityDefinitions
  * [$apply](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#apply)


##  10.4.1.3Apply[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/activity_definitions.html#apply)
...
10.4.1.3.1Parameters The following parameters are supported for the `ActivityDefinition/$apply` operation: Parameter | Type | Description  
---|---|---  
...
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/measures.html)
10.4 ActivityDefinitions 
* Clinical Reasoning 
