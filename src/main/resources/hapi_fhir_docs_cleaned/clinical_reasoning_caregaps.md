---
source: https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html
crawled: 2025-08-01T14:06:06.382013
---

# Clinical Reasoning Caregaps

#  10.2.1Care Gaps
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html#care-gaps)
##  10.2.1.1Overview[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html#overview)
...
[![Care Gaps Flow](https://hapifhir.io/hapi-fhir/docs/images/caregapsflow.png)](https://hapifhir.io/hapi-fhir/docs/images/caregapsflow.png)Sourced from [Implementation Guide](http://hl7.org/fhir/us/davinci-deqm/2023Jan/gaps-in-care-reporting.html)
...
##  10.2.1.2Gaps in Care Reporting[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html#gaps-in-care-reporting)
...
##  10.2.1.3Operations[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html#operations)
...
##  10.2.1.4Care Gaps[](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/caregaps.html#care-gaps-1)
The `$care-gaps` operation is used to run a Gaps in Care Report.
10.2.1.4.1Testing care gaps on Hapi FHIR Hapi FHIR is integrated with `$care-gaps` operations and following are the steps to identify open gap on sample data following the remediation step to generate a report for closed gap.
...
Copy
[ ](https://hapifhir.io/hapi-fhir/docs/clinical_reasoning/cql.html)
10.2 Care Gaps 
* Clinical Reasoning 
