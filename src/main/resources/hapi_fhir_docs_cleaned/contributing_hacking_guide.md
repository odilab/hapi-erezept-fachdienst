---
source: https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html
crawled: 2025-08-01T14:05:20.857534
---

# Contributing Hacking Guide

#  16.0.1Hacking HAPI FHIR
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#hacking-hapi-fhir)
This page contains useful information about how to get started in developing HAPI FHIR itself.
#  16.0.2Understanding the HAPI FHIR Codebase
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#understanding-the-hapi-fhir-codebase)
...
#  16.0.3Getting the Sources
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#getting-the-sources)
...
#  16.0.4Building HAPI FHIR
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#building-hapi-fhir)
...
Copy
#  16.0.5Rebuilding the Database Schema
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#rebuilding-the-database-schema)
...
Copy
#  16.0.6Troubleshooting
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#troubleshooting)
...
Copy
  * **If you are trying to build a submodule** (e.g. `hapi-fhir-jpaserver-base`), try building the root project first. Especially when building from the Git `master`, often times there will be dependencies that require a fresh complete build (note that this is not generally an issue when building from a release version)
...
#  16.0.7Importing into Eclipse
[ ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#importing-into-eclipse)
...
![](https://hapifhir.io/hapi-fhir/docs/images/hacking_import.png)
**Select the Projects**
...
![](https://hapifhir.io/hapi-fhir/docs/images/hacking_import_step2.png)
##  16.0.7.1Troubleshooting[](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html#troubleshooting-1)
...
* [ 16.0  Hacking Guide ](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html)
* * *
