---
source: https://hapifhir.io/hapi-fhir/docs/appendix/logging.html
crawled: 2025-08-01T14:05:30.348597
---

# Appendix Logging

#  17.0.1Logging
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#logging)
...
##  17.0.1.1Quick Start: Using Logback[](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#quick-start-using-logback)
...
#  17.0.2Configuring HAPI's Logging - SLF4j
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#configuring-hapis-logging-slf4j) ![Logging arch diagram](https://hapifhir.io/hapi-fhir/docs/images/hapi-fhir-logging.svg)
HAPI uses [SLF4j](http://www.slf4j.org/) for all internal logging. SLF4j is a _logging facade_ framework, meaning that it doesn't actually handle log output (i.e. it isn't actually writing log lines to disk) but rather it is able to delegate that task to any of a number of underlying frameworks (e.g. log4j, logback, JDK logging, etc.)
...
##  17.0.2.1Commons-Logging[](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#commons-logging)
![Logging arch diagram](https://hapifhir.io/hapi-fhir/docs/images/hapi-fhir-logging-complete.svg)
...
#  17.0.3Client Payload Logging
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#client-payload-logging)
To enable detailed logging of client requests and responses (what URL is being requested, what headers and payload are being received, etc.), an interceptor may be added to the client which logs each transaction. See [Logging Requests and Responses](https://hapifhir.io/hapi-fhir/docs/interceptors/built_in_client_interceptors.html#logging_interceptor) for more information.
#  17.0.4Server Request Logging
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#server-request-logging)
To enable detailed logging of server requests and responses, an interceptor may be added to the server which logs each transaction. See [Logging Interceptor](https://hapifhir.io/hapi-fhir/docs/interceptors/built_in_server_interceptors.html#logging_interceptor) for more information.
#  17.0.5Hibernate SQL Log Filtering
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#hibernate-sql-log-filtering)
...
##  17.0.5.1Hibernate SQL Log Filtering example[](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html#hibernate-sql-log-filtering-example)
...
17.0 Logging 
* Appendix 
* [ 17.0  Logging ](https://hapifhir.io/hapi-fhir/docs/appendix/logging.html)
* [ 17.1  FAQ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html)
* [ 17.2  JavaDocs ](https://hapifhir.io/hapi-fhir/docs/appendix/javadocs.html)
[ 17.1 FAQ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html)
* * *
