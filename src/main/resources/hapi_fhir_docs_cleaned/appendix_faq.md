---
source: https://hapifhir.io/hapi-fhir/docs/appendix/faq.html
crawled: 2025-08-01T14:08:41.472498
---

# Appendix Faq

#  17.1.1Frequently Asked Questions
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html#frequently-asked-questions)
#  17.1.2Getting Help
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html#getting-help) 17.1.2.0.1Where can I ask questions or get help?
...
#  17.1.3Using HAPI FHIR
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html#using-hapi-fhir) 17.1.3.0.1What JDK version does HAPI support?
See the [HAPI FHIR Versions](https://hapifhir.io/hapi-fhir/docs/getting_started/versions.html) page for information on the current minimum Java version required in order to use HAPI FHIR.
#  17.1.4JPA Server
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html#jpa-server) 17.1.4.0.1I would like to connect to the Derby database using a JDBC database browser (e.g. Squirrel, Toad, DBVisualizer) so that I can access the underlying tables. How do I do that? By default Derby doesn't actually open any TCP ports for you to connect externally to it. Being an embedded database, it works a bit differently than other databases in that the client actually is the database and there's no outside communication with it possible. There are a few options available to work around this fact:
...
#  17.1.5Contributing
[ ](https://hapifhir.io/hapi-fhir/docs/appendix/faq.html#contributing) 17.1.5.0.1My build is failing with the following error: *The forked VM terminated without properly saying goodbye. VM crash or System.exit called?* The complete error message typically resembles: ```
...
See [Hacking HAPI FHIR](https://hapifhir.io/hapi-fhir/docs/contributing/hacking_guide.html) for more information on the build process.
