---
source: https://hapifhir.io/hapi-fhir/docs/security/cors.html
crawled: 2025-08-01T14:05:31.395379
---

# Security Cors

#  12.4.1CORS (Cross-Origin Resource Sharing)
[ ](https://hapifhir.io/hapi-fhir/docs/security/cors.html#cors-cross-origin-resource-sharing)
...
#  12.4.2HAPI FHIR CORS Interceptor
[ ](https://hapifhir.io/hapi-fhir/docs/security/cors.html#cors_interceptor)
...
Spring is generally unlikely to conflict with other libraries so it is usually safe to add it to your classpath, but it is a fairly large library so if size is a concern you might opt to use a filter instead.
  * [CorsInterceptor JavaDoc](https://hapifhir.io/hapi-fhir/apidocs/hapi-fhir-server/ca/uhn/fhir/rest/server/interceptor/CorsInterceptor.html)
...
Copy
#  12.4.3CORS Servlet Filter
[ ](https://hapifhir.io/hapi-fhir/docs/security/cors.html#cors-servlet-filter)
Note that in previous revisions of HAPI FHIR documentation we recommended using the [eBay CORS Filter](https://github.com/ebay/cors-filter), but as of 2016 the eBay filter is no longer being maintained and contains known bugs. We now recommend against using this filter. 
