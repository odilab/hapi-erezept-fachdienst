---
source: https://hapifhir.io/hapi-fhir/docs/server_plain/server_types.html
crawled: 2025-08-01T14:05:44.293985
---

# Server Plain Server Types
...
##  4.0.1.1Plain Server / Facade[](https://hapifhir.io/hapi-fhir/docs/server_plain/server_types.html#plain-server-facade)
...
To get started with the Plain Server, jump to [Plain Server Introduction](https://hapifhir.io/hapi-fhir/docs/server_plain/introduction.html).
##  4.0.1.2JPA Server[](https://hapifhir.io/hapi-fhir/docs/server_plain/server_types.html#jpa-server)
...
##  4.0.1.3JAX-RS Server[](https://hapifhir.io/hapi-fhir/docs/server_plain/server_types.html#jax-rs-server)
