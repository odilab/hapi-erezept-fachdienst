...
public class CloseOperationProvider implements IResourceProvider {
    ...
    public Bundle closeTaskOperation(
            ...
            @OperationParam(name = "secret", min = 1) StringType secret,
        ...
        try {
            ...
            if (rxDispensation != null && !rxDispensation.isEmpty()) {
            ...
            // 11. Erstelle Receipt Bundle (A_19233-05)
            ...
            // 12. Setze Task-Status auf completed (A_19232)
    ...
    private Binary loadPrescriptionBinary(Task task) {
        // TODO: Implementierung abhängig von wie Binary gespeichert wird
        // Möglicherweise über HealthCarePrescriptionUuid Extension
        return null;
    }
    ...
    private Date getInProgressDate(Task task) {
        // TODO: Implementierung - wahrscheinlich aus Task.lastModified oder Extension
        return task.getLastModified() != null ? task.getLastModified() : new Date();
    }
    ...
    private void deleteCommunicationsForTask(String taskId) {
        ...
        // TODO: Iteriere über Ergebnisse und lösche sie
        LOGGER.debug("Communications für Task {} gelöscht", taskId);
    }
