...
public class ActivateOperationIntegrationTest extends BaseProviderTest {
    ...
    private String createSignedBundleForTest(String prescriptionId, String kvnr) {
        try {
            // Erstelle Test KBV Bundle XML
            String bundleXml = createTestKbvBundleXml(prescriptionId, kvnr);
            ...
            body.add("kbvBundleAsString", bundleXml);
            body.add("kbvBundleFromFile", "");
    ...
    /**
     * Erstellt ein minimales Test KBV Bundle XML.
     */
